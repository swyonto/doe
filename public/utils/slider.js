// Ensure DOM is loaded before running slider code
...
function initSlider() {
  ...
  const slides    = document.querySelectorAll('#slidesTrack .slide');   // Only carousel slides
  const dots      = document.querySelectorAll('#carouselDots .dot');     // Only carousel dots
